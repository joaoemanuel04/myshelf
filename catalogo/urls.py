...
from .views import registrar, login_view, home_antes_do_login, home_depois_do_login, avaliar_filme, listar_filmes_favoritos, adicionar_filmes_favoritos, remover_filmes_favoritos
